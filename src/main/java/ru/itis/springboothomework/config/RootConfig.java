...
@Configuration
@EnableJpaRepositories(basePackages = {"ru.itis.springboothomework.repository"})
@ComponentScan(basePackages = {"ru.itis.springboothomework"})
